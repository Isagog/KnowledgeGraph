...
public class ListApi  {
   private final ListApiService delegate = ListApiServiceFactory.getListApi();
    ...
    @io.swagger.annotations.ApiOperation(value = "Lists Knowledge Graphs", notes = "Returns the list of available KGs (id)", response = String.class, responseContainer = "List", tags={ "KnowledgeService", })
