...
import com.isagog.kg.service.factories.InteractionServiceApiServiceFactory;
...
,@ApiParam(value = "" ) List<InteractRecord> interactRecord
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Sends an interaction sequence for processing", notes = "Sends list of interaction records to be processed", response = IssueResponse.class, tags={ "InteractionService", })
    @io.swagger.annotations.ApiResponses(value = { 
