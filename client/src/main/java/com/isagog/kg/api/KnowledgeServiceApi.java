...
public interface KnowledgeServiceApi extends ApiClient.Api {
   ...
   */
  @RequestLine("GET /{kg}/get?content={content}")
  @Headers({
    "Accept: application/json",
  })
  ...
  KnowledgeGraph getGraph(@Param("kg") String kg, @QueryMap(encoded=true) Map<String, Object> queryParams);
   ...
   */
  @RequestLine("GET /{kg}/lookup?id={id}")
  @Headers({
    "Accept: application/json",
  })
