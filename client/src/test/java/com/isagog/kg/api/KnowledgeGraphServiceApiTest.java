...
/**
 * API tests for KnowledgeGraphServiceApi
 */
public class KnowledgeGraphServiceApiTest {

    private KnowledgeGraphServiceApi api;

    @Before
    public void setup() {
        api = new ApiClient().buildClient(KnowledgeGraphServiceApi.class);
    }
    ...
    public void analyzeSentenceTestQueryMap() {
        TextualContent textualContent = null;
        KnowledgeGraphServiceApi.AnalyzeSentenceQueryParams queryParams = new KnowledgeGraphServiceApi.AnalyzeSentenceQueryParams()
            .kg(null)
            .task(null);
     ...
     */
    @Test
    public void deleteGraphTestQueryMap() {
        KnowledgeGraphServiceApi.DeleteGraphQueryParams queryParams = new KnowledgeGraphServiceApi.DeleteGraphQueryParams()
            .kg(null);
        // api.deleteGraph(queryParams);
    ...
    public void evaluateEntityTestQueryMap() {
        KnowledgeGraphServiceApi.EvaluateEntityQueryParams queryParams = new KnowledgeGraphServiceApi.EvaluateEntityQueryParams()
            .kg(null)
            .id(null)
            .concept(null)
            .method(null);
    ...
    public void getGraphTestQueryMap() {
        KnowledgeGraphServiceApi.GetGraphQueryParams queryParams = new KnowledgeGraphServiceApi.GetGraphQueryParams()
            .kg(null)
            .content(null);
        // KnowledgeGraph response = api.getGraph(queryParams);
    ...
    public void getKnowledgeElementTestQueryMap() {
        String kg = null;
        KnowledgeGraphServiceApi.GetKnowledgeElementQueryParams queryParams = new KnowledgeGraphServiceApi.GetKnowledgeElementQueryParams()
            .id(null);
    ...
    public void listGraphsTestQueryMap() {
        KnowledgeGraphServiceApi.ListGraphsQueryParams queryParams = new KnowledgeGraphServiceApi.ListGraphsQueryParams()
            .summary(null);
    ...
    public void queryTestQueryMap() {
        Query query = null;
        KnowledgeGraphServiceApi.QueryQueryParams queryParams = new KnowledgeGraphServiceApi.QueryQueryParams()
            .kg(null);
    ...
    public void searchTestQueryMap() {
        KnowledgeGraphServiceApi.SearchQueryParams queryParams = new KnowledgeGraphServiceApi.SearchQueryParams()
            .kg(null)
            .query(null)
            .attribute(null);
