...
public class DataServiceApi  {
   private final DataServiceApiService delegate = DataServiceApiServiceFactory.getDataServiceApi();
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "Missing implementation", response = Void.class) })
    public Response createStatement(@ApiParam(value = "Statement specification" ,required=true) EntityStatement entityStatement
)
    throws NotFoundException {
        return delegate.createStatement(entityStatement);
    }
    @DELETE
    @Path("/entities/{id}")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 503, message = "Missing implementation", response = Void.class) })
    public Response deleteStatement(@ApiParam(value = "Statement specification" ,required=true) EntityStatement entityStatement
)
    throws NotFoundException {
        return delegate.deleteStatement(entityStatement);
    }
    @GET
    @Path("/entities/{id}")
    
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Element access", notes = "Returns a KnowledgeElement", response = Entity.class, tags={ "DataService", })
    @io.swagger.annotations.ApiResponses(value = { 
