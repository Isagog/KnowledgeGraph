...
public abstract class KnowledgeServiceApiService {
 ...
 ,SentenceAnnotation sentenceAnnotation
    ...
    public abstract Response getAttribute(URI id
 ) throws NotFoundException;
    public abstract Response getConcept(URI id
 ) throws NotFoundException;
    public abstract Response getFrame(URI id
 ) throws NotFoundException;
    public abstract Response getRelation(URI id
 ) throws NotFoundException;
