...
,@ApiParam(value = "" ) SentenceAnnotation sentenceAnnotation
    ...
    public Response getAttribute(@ApiParam(value = "The attribute's id",required=true) @PathParam("id") URI id
)
    throws NotFoundException {
    ...
    public Response getConcept(@ApiParam(value = "The concept's id",required=true) @PathParam("id") URI id
)
    throws NotFoundException {
    ...
    public Response getFrame(@ApiParam(value = "The frame's id",required=true) @PathParam("id") URI id
)
    throws NotFoundException {
    ...
    public Response getRelation(@ApiParam(value = "The relation's id",required=true) @PathParam("id") URI id
)
    throws NotFoundException {
